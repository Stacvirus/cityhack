export default function Newsletter() {
  return (
    <section className="max-w-[40rem] m-auto bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
        ...
        >
          ...
          <span className="text-sm font-medium">
            Jumbotron component was launched! See wha&apos;s new
          </span>
          <svg
        ...
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
          We invest in the world&apos; potential
        </h1>
